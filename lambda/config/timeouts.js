...
module.exports = {
    ...
    WOLFRAM_TIMEOUT: 2000,              // Wolfram Alpha - consultas normales (optimizado: 0.8s scan = ~1s respuesta)
    WOLFRAM_TIMEOUT_SBS: 4500,          // Wolfram Alpha step-by-step - cálculos complejos
